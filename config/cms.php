...
return [
    ...
    */
    ...
    'backendUri' => env('CMS_BACKEND_URI', ''),
    ...
    */
    ...
    'backendTimezone' => env('CMS_BACKEND_TIMEZONE', 'UTC'),
    ...
    */
    ...
    'loadModules' => explode(',', env('CMS_LOAD_MODULES', 'System,Backend')),
    ...
    */
    ...
    'pluginsPath' => env('CMS_PLUGIN_PATH', '/plugins'),
    ...
    */
    ...
    'themesPath' => env('CMS_THEME_PATH', '/themes'),
    ...
    */
    ...
    'storage' => [
        ...
        'uploads' => [
            'disk'            => env('FILESYSTEMS_DRIVER', 'local'),
            'folder'          => 'uploads',
            'path'            => env('STORAGE_UPLOAD_PATH', '/storage/app/uploads'),
